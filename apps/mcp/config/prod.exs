...
node_id = "mcp"
run_node = String.to_atom("#{node_id}@joule.wisslanding.com")
autostart = :true
scope = :global
max_restarts = 1
max_seconds = 1
auto_populate = :true
i2c_sensor_mode = :actual
i2c_use_multiplexer = :true
influx = %{db: "mcp_repo", host: "jophiel.wisslanding.com:8086",
           user: "updater", pass: "mcp"}
...
config :mcp, Mcp.Repo,
  ...
  database: "mcp_prod",
  username: "mcp_sys",
  password: System.get_env("MCP_DB_PASS_P"),
  ...
  genservers: %{
    ...
    Elixir.Mcp.Chamber =>
      %{name: {scope, Mcp.Chamber},
        ...
        routine_check_ms: 3_000},

    Elixir.Mcp.Mixtank =>
      %{name: {scope, Mcp.Mixtank},
        run_node: run_node,
        control_temp_ms: 20_000, activate_ms: 1000, manage_ms: 1000},
