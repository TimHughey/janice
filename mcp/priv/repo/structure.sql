...
--
-- Name: dutycycle_profile_dutycycle_id_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX dutycycle_profile_dutycycle_id_name_index ON public.dutycycle_profile USING btree (dutycycle_id, name);
