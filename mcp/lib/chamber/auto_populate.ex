  ...
  defp default_chambers do
    [
      %Chamber{
        ...
        enable: false,
        temp_sensor_pri: "ts_shroom1",
        temp_sensor_sec: "ts_curetank",
        temp_setpt: 85,
        heat_sw: "buzzer",
        heat_control_ms: 20_000,
        relh_sensor: "rh_simulate",
        relh_sw: "buzzer",
        relh_control_ms: 20_000,
        air_stir_sw: "buzzer",
        air_stir_temp_diff: 5,
        fresh_air_sw: "buzzer",
        fresh_air_freq_ms: 900_000,
      ...
      %Chamber{
        ...
        enable: false,
        temp_sensor_pri: "i2c_am2315",
        temp_sensor_sec: "ts_shroom1",
        temp_setpt: 85,
        heat_sw: "shroom1_heat",
        heat_control_ms: 20_000,
        relh_sensor: "i2c_am2315",
        relh_sw: "shroom1_mist",
        relh_control_ms: 20_000,
        air_stir_sw: "shroom1_air",
        air_stir_temp_diff: 5,
        fresh_air_sw: "shroom1_fresh_air",
        fresh_air_freq_ms: 900_000,
        fresh_air_dur_ms: 600_000
      }
    ]
